...
export class EmployeeCalculate extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { id: 0, fullName: '', birthdate: '', tin: '', typeId: 1, noOfAbsenceorWorkDays: 0, netIncome: 0, loading: true, loadingCalculate: false };
    }
            ...
            : <div>
                <form>
                    ...
                    <div className="form-row">
                            ...
                            {this.state.typeId === 1 ? <label htmlFor='inputAbsentDays4'>Absent Days: </label> : <label htmlFor='inputWorkDays4'>Worked Days: </label>}
                            <input type='text' className='form-control' id='inputNoOfAbsenceorWorkDays4' onChange={this.handleChange.bind(this)} value={this.state.absentDays} name="noOfAbsenceorWorkDays" placeholder={this.state.typeId === 1 ? 'Absent Days' : 'Worked Days'} />
                            </div> 
    ...
    async calculateSalary() {
        ...
        const response = await fetch('api/employees/' + this.state.id + '/calculate/' + this.state.noOfAbsenceorWorkDays , requestOptions);
